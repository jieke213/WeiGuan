...
public class StatusesAPI extends AbsOpenAPI {
    ...
    private static final int READ_API_SHOW			   = 6;
    private static final int READ_API_GO			   = 7;
    ...
    static {
        ...
        sAPIList.put(READ_API_GO, 				API_BASE_URL + "/go.json");
    }
    ...
    public void go(long uid,long id,RequestListener listener){
    	WeiboParameters params = buildGoParameters(uid, id);
    	requestAsync(sAPIList.get(READ_API_GO), params, HTTPMETHOD_GET, listener);
    }
    
    private WeiboParameters buildGoParameters(long uid, long id){
    ...
    private WeiboParameters buildShowParams(long id){
    	WeiboParameters params = new WeiboParameters(mAppKey);
    	params.put("id", id);
    	return params;
    }
